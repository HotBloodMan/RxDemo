...
public class CreditCardDao extends AbstractDao<CreditCard, Long> {
    ...
    private Query<CreditCard> student_CardListQuery;
    ...
    /** Internal query to resolve the "cardList" to-many relationship of Student. */
    public List<CreditCard> _queryStudent_CardList(Long id) {
        synchronized (this) {
            if (student_CardListQuery == null) {
                QueryBuilder<CreditCard> queryBuilder = queryBuilder();
                queryBuilder.where(Properties.Id.eq(null));
                student_CardListQuery = queryBuilder.build();
            }
        }
        Query<CreditCard> query = student_CardListQuery.forCurrentThread();
